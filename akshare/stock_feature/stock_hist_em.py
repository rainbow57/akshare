...
from akshare.utils.func import fetch_paginated_data, fetch_paginated_data_page
...
def stock_zh_a_spot_em_page(page: str) -> pd.DataFrame:
    """
    东方财富网-沪深京 A 股-实时行情
    https://quote.eastmoney.com/center/gridlist.html#hs_a_board
    :return: 实时行情
...
def stock_sh_a_spot_em_page(page: str) -> pd.DataFrame:
    """
    东方财富网-沪 A 股-实时行情
    https://quote.eastmoney.com/center/gridlist.html#hs_a_board
    :return: 实时行情
...
def stock_sz_a_spot_em_page(page: str) -> pd.DataFrame:
    """
    东方财富网-深 A 股-实时行情
    https://quote.eastmoney.com/center/gridlist.html#hs_a_board
    :return: 实时行情
...
def stock_bj_a_spot_em_page(page: str) -> pd.DataFrame:
    """
    东方财富网-京 A 股-实时行情
    https://quote.eastmoney.com/center/gridlist.html#hs_a_board
    :return: 实时行情
